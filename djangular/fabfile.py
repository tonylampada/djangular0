"""
Starter fabfile for deploying the djangular project.
...
# CHANGEME
env.hosts = ['user@djangular.example.com']
env.code_dir = '/srv/www/djangular'
env.project_dir = '/srv/www/djangular/djangular'
env.static_root = '/srv/www/djangular/static/'
env.virtualenv = '/srv/www/djangular/.virtualenv'
env.code_repo = 'git@github.com:user/djangular.git'
env.django_settings_module = 'djangular.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/djangular/wsgi.py" % env.code_dir)
