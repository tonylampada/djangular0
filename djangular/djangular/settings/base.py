...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'djangular.settings.base.custom_show_toolbar',
...
SYSTEM_EMAIL_PREFIX = "[djangular]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_djangular"  # Make this unique to your project.
